<template>
	<div class="diy_details page_product_information" id="product_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_product_information'>
							<div_product_information :obj="obj"></div_product_information>
...
<script>
	import div_product_information from "@/components/diy/div_product_information.vue";
		...
		methods:{
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.product_information_id;
				}
			},
			/**
			 * 初始化收藏状态
