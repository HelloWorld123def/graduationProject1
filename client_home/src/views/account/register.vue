							...
							<div class="form_register">
								<b-form>
									...
									<b-form-group id="input-group-7" label="身份:" label-for="input-7">
										...
										<!--住户用户-->
									<form_household_users v-if="form.user_group === '住户用户'" :form="form_sub"></form_household_users>
...
<script>
	import mixin from "@/mixins/page.js";
		/*[loop tables o idx]*/
	/*[if o.config.register_page === "前注册" || o.config.register_page === "前后注"]*/
	/* 住户用户 */
	import form_household_users from "@/components/diy/form_household_users";
	/*[/if]*/
	/*[/loop]*/
