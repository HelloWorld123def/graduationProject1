			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						店铺名称
							...
							<th class="diy_title" v-if="$check_field('get','merchant_information')">
						商户信息
					</th>
							<th class="diy_title" v-if="$check_field('get','trade_name')">
						商品名称
					</th>
							<th class="diy_title" v-if="$check_field('get','commodity_price')">
						商品价格
					</th>
						...
						购买数量
							...
							<th class="diy_title" v-if="$check_field('get','total_purchase_price')">
						购买总价
					</th>
							<th class="diy_title" v-if="$check_field('get','shipping_address')">
						配送地址
					</th>
							<th class="diy_title" v-if="$check_field('get','purchase_remarks')">
						购买备注
					</th>
							<th class="diy_title" v-if="$check_field('get','order_status')">
						订单状态
					</th>
							<th class="diy_title" v-if="$check_field('get','delivery_information')">
						配送信息
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_uid" v-if="$check_field('get','merchant_information')">
						<span>
							{{ get_user_name(o['merchant_information']) }}
						</span>
					</td>
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','total_purchase_price')">
						<span>
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','delivery_information')">
						<span>
