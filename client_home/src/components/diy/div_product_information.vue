<template>
	<div class="diy_details_box diy_div_product_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/purchase_information/edit','add')" @click="to_form('/purchase_information/edit')" > 购买 </button>
											<button class="btn btn-primary details_btn" v-if="$check_action('/product_information/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/product_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
				...
				if (this.state_collect) {
					...
					this.state_collect = true;
																		query.title = this.obj.trade_name
																			query.img = this.obj.product_picture
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var product_information_id = this.obj.product_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "product_information",
          source_field: "product_information_id",
          source_id: product_information_id
        }, (res) => {
