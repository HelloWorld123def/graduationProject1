		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','commodity_price')" min-width="200">
					...
					<el-table-column prop="product_picture" @sort-change="$sortChange" label="商品图片"
				v-if="user_group == '管理员' || $check_field('get','product_picture')" min-width="200">
						<template slot-scope="scope">
					<el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['product_picture'])"
						:preview-src-list="[$fullUrl(scope.row['product_picture'])]">
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/product_information/table','set') || $check_action('/product_information/view','set') || $check_action('/product_information/view','get') || $check_action('/购买/table','add') || $check_action('/购买/view','add')" >
