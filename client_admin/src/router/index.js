...
const routes = [
	...
	// 住户用户路由
	{
		path: '/household_users/table',
		name: 'household_users_table',
		component: () => import('../views/household_users/table.vue')
	},
	{
		path: '/household_users/view',
		name: 'household_users_view',
		component: () => import('../views/household_users/view.vue')
	},
	// 商户用户路由
	{
		path: '/merchant_user/table',
		name: 'merchant_user_table',
		component: () => import('../views/merchant_user/table.vue')
	},
	{
		path: '/merchant_user/view',
		name: 'merchant_user_view',
		component: () => import('../views/merchant_user/view.vue')
	},
	// 商品信息路由
	{
	...
	// 疫情服务路由
	{
		path: '/epidemic_service/table',
		name: 'epidemic_service_table',
		component: () => import('../views/epidemic_service/table.vue')
	},
	{
		path: '/epidemic_service/view',
		name: 'epidemic_service_view',
		component: () => import('../views/epidemic_service/view.vue')
	},
	// 类型管理路由
	{
	...
	// 申请信息路由
	{
		path: '/application_information/table',
		name: 'application_information_table',
		component: () => import('../views/application_information/table.vue')
	},
	{
		path: '/application_information/view',
		name: 'application_information_view',
		component: () => import('../views/application_information/view.vue')
	},
